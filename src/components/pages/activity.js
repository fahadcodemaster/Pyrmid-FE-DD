  ...
  <section className='container'>
    ...
    <ul className="activity-list">
      ...
      <li className="act_sale">
          <img className="lazy" src="./images/items/thumbnail-2.jpg" alt=""/>
          <div className="act_list_text">
      ...
      <li className="act_sale">
          <img className="lazy" src="./images/items/thumbnail-4.jpg" alt=""/>
          <div className="act_list_text">
              <h4>Two Tigers</h4>
      ...
      <li className="act_like">
          <img className="lazy" src="./images/items/thumbnail-7.jpg" alt=""/>
          <div className="act_list_text">
      ...
      <li className="act_offer">
          <img className="lazy" src="./images/items/thumbnail-5.jpg" alt=""/>
          <div className="act_list_text">
              <h4>Purple Planet</h4>
      ...
      <li className="act_like">
          <img className="lazy" src="./images/items/thumbnail-6.jpg" alt=""/>
          <div className="act_list_text">
              <h4>Cute Astronout</h4>
             liked by <span className='color'>Nicholas Daniels</span>
              <span className="act_list_date">
