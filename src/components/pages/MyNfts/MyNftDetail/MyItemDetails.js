...
//                   <ul className="timer">
//                     <li>
//                       <p>{days ? days: days === 0 ?  0: <RingLoader color="white" size="20" width="10"/>}</p>
//                       <span>Days</span>
//                     </li>
//                     <li>
//                       <p>{hours ? hours: hours === 0 ? 0: <RingLoader color="white" size="20" width="10" />}</p>
//                       <span>Hours</span>
//                     </li>
//                     <li>
//                       <p>{minutes ? minutes: minutes === 0 ? 0: <RingLoader color="white" size="20" width="10" />}</p>
//                       <span>Min</span>
//                     </li>
//                     <li>
//                       <p>{seconds ? seconds: seconds === 0 ? 0: <RingLoader color="white" size="20" width="10" />}</p>
//                       <span>Sec</span>
//                     </li>
//                   </ul>
//                 </div>
